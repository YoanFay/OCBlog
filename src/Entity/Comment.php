...
class Comment
{
    ...
    /**
     * @param bool|string $init   parameter
     * @param int|null    $idPost parameter
     */
    public function __construct($init = false, int $idPost = null)
    {
     ...
     * @return void
     */
    public function default(int $idPost)
    {
     ...
     * @return void
     */
    public function setId(int $post_id): void
    {
